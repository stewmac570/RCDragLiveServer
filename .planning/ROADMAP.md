...
Plans:
- [x] 03-01: Add the public live data endpoint and no-cache response behavior
- [x] 03-02: Add the health endpoint and end-to-end public smoke verification
...
| 3. Public Live Data Access | 2/2 | Complete | 2026-03-20 |
